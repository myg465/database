	 	...
	 	<header>
	 		...
	 		<nav>
	 			...
	 			<ul>
	 				...
	 				<li class="menu_list"><a href="#">MY쿡킷</a></li>
	 			</ul>
	 			<ul>
				...
				<div>
					...
					<ul>
						<li>
							<a href="#">
								<span>
									<img alt="황태콩나물해장국" src="img/menu01.png">
								</span>
								<span>황태콩나물해장국</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="군산식 아귀찜" src="img/menu02.png">
								</span>
								<span>군산식 아귀찜</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="해물짬뽕전골" src="img/menu03.png">
								</span>
								<span>해물짬뽕전골</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="스키야키" src="img/menu04.png">
								</span>
								<span>스키야키</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="우삼겹쌀국수" src="img/menu05.png">
								</span>
								<span>우삼겹쌀국수</span>
								<span>24,800원<span>/3인분</span></span>
							</a>
						...
						<li>
							<a href="#">
								<span>
									<img alt="빠네크림파스타" src="img/menu06.png">
								</span>
								<span>빠네크림파스타</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="감바스알아히요" src="img/menu07.png">
								</span>
								<span>감바스알아히요</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="대만식 우육탕면" src="img/menu08.png">
								</span>
								<span>대만식 우육탕면</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="얼큰소고기우거지탕" src="img/menu09.png">
								</span>
								<span>얼큰소고기우거지탕</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="두툼 갈치조림" src="img/menu10.png">
								</span>
								<span>두툼 갈치조림</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="부추가득 오리불고기" src="img/menu11.png">
								</span>
								<span>부추가득 오리불고기</span>
								<span>24,800원<span>/3인분</span></span>
							</a>
						...
						<li>
							<a href="#">
								<span>
									<img alt="버섯소불고기" src="img/menu12.png">
								</span>
								<span>버섯소불고기</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="속초식 코다리찜" src="img/menu13.png">
								</span>
								<span>속초식 코다리찜</span>
								<span>24,800원<span>/3인분</span></span>
							</a>
						...
						<li>
							<a href="#">
								<span>
									<img alt="사천식 깐풍새우" src="img/menu14.png">
								</span>
								<span>사천식 깐풍새우</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="애호박돼지고기짜글이" src="img/menu15.png">
								</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="칠리&크림 반반새우" src="img/menu16.png">
								</span>
						...
						<li>
							<a href="#">
								<span>
									<img alt="쿵팟퐁커리" src="img/menu17.png">
								</span>
								<span>쿵팟퐁커리</span>
								<span>20,800원<span>/3인분</span></span>
							</a>
						...
						<li>
							<a href="#">
								<span>
									<img alt="소고기두부전골" src="img/menu18.png">
								</span>
								<span>소고기두부전골</span>
								<span>24,800원<span>/3인분</span></span>
							</a>
						...
						<li>
							<a href="#">
								<span>
									<img alt="부채살 찹스테이크" src="img/menu19.png">
								</span>
								<span>부채살 찹스테이크</span>
								<span>20,800원<span>/2인분</span></span>
							</a>
