...
<body>
  <section>
    ...
    <table>
      ...
      <tr>
        <td colspan="3"><strong>다음글</strong> <span class="separator">|</span> <a href="#"></a></td>
      </tr>
      <tr>
        <td colspan="3"><strong>이전글</strong> <span class="separator">|</span> <a href="#"></a></td>
      </tr>
    </table>
    ...
    <a href="modify_view.do?bId=${content_view.bId }&page=${page}">
	    <div class="list">
	   		 수정
	    </div>
    </a>
    <a href="reply_view.do?bId=${content_view.bId }&page=${page}">
	    <div class="list">
	   		 답글달기
	    </div>
    </a>
